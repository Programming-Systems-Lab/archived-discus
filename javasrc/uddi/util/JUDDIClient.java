 ...
 * @version 0.6
 */
public class JUDDIClient extends org.uddi4j.client.UDDIProxy
{
  // Variables
   ...
   */
  public JUDDIClient(Properties p) 
   ...
   * {@link #JUDDIClient(Properties)} for configuration details.
   * @exception java.net.MalformedURLException In case the publish or
   *            inquiry URLs are malformed.
   */
