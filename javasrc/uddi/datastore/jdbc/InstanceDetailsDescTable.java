 ...
 * @version 0.6
 */
public class InstanceDetailsDescTable
{
  ...
  static
  {
    ...
    sql.append("PRIMARY KEY (BINDING_KEY,TMODEL_INSTANCE_INFO_ID,INSTANCE_DETAILS_ID,INSTANCE_DETAILS_DESCR_ID),");
   ...
   */
  public static void insert(String bindingKey,int tModelInstanceInfoID,int instanceDetailsID,Vector descList,Connection connection)
    throws psl.discus.javasrc.uddi.error.JUDDIException, java.sql.SQLException
  {
    if (descList == null)
    ...
    try
    {
      ...
      for (int i=0; i<listSize; i++)
      {
        ...
        statement.setInt(4,descID);   // Sequence Number aka Desc ID
        statement.setString(5,desc.getLang());
        statement.setString(6,desc.getText());
   ...
   * @throws psl.discus.javasrc.uddi.error.JUDDIException, java.sql.SQLException
   */
  public static Vector select(String bindingKey,int tModelInstanceInfoID,int instanceDetailsID,Connection connection)
    throws psl.discus.javasrc.uddi.error.JUDDIException, java.sql.SQLException
  {
    if (bindingKey == null)
  ...
  public static void test(Connection connection)
  {
    ...
    if (connection != null)
    {
      try
      {
        ...
        InstanceDetailsDescTable.insert(bindingKey,infoID,detailsID,descList,connection);

        // select the Collection of Description objects
        descList = InstanceDetailsDescTable.select(bindingKey,infoID,detailsID,connection);
